...
//   useEffect(() => {
//     if (userData) storeUserData(userData, points);
//   }, [points, userData]);
...
//   const handleSubmit = () => {
//     if (input === captcha) {
//       const pointsEarned = difficulty === 'easy' ? 1 : difficulty === 'medium' ? 5 : 20;
...
//   buttonContainer: { display: 'flex', gap: '10px', marginBottom: '20px', marginTop: '-150px' },
