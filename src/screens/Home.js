...
const Home = () => {
  ...
  const generateCaptcha = () => setCaptcha(Array.from({ length: 7 }, () => 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'.charAt(Math.floor(Math.random() * 62))).join(''));
...
const styles = {
  container: { display: 'flex', flexDirection: 'column', height: '100vh', color: '#fff', width: '100vw', fontFamily: 'Roboto, sans-serif' },
  ...
  progressBarContainer: { flex: 1, height: '10px', backgroundColor: '#444', borderRadius: '5px', overflow: 'hidden', marginRight: '10px' },
  ...
  difficultyButton: { padding: '10px 20px', fontSize: '1rem', backgroundColor: '#333', color: '#fff', border: '1px solid #444', borderRadius: '5px', cursor: 'pointer', transition: 'background-color 0.3s ease' },
  captchaContainer: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' },
  captchaBox: { fontSize: '2rem', backgroundColor: '#1f1f1f', padding: '15px', borderRadius: '5px', display: 'flex', alignItems: 'center', border: '1px solid #444', position: 'relative', userSelect: 'none' },
  refreshIcon: { marginLeft: '10px', cursor: 'pointer', fontSize: '1.2rem', color: '#fff', transition: 'color 0.3s ease' },
  timer: { fontSize: '1rem', marginTop: '5px', marginBottom: '40px' },
  input: { padding: '10px', fontSize: '1rem', borderRadius: '5px', border: '1px solid #444', backgroundColor: '#2b2b2b', color: '#fff', width: '200px', marginBottom: '10px' },
  submitButton: { width: '150px', padding: '10px 20px', fontSize: '1rem', backgroundColor: '#333', color: '#fff', border: '1px solid #fff', borderRadius: '5px', cursor: 'pointer', transition: 'background-color 0.3s ease, transform 0.2s ease', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.2)' }
};
